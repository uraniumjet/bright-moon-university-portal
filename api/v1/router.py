...
from api.v1.endpoints.academic import router as academic_router
from api.v1.endpoints.lms import router as lms_router
from api.v1.endpoints.bursary import router as busary_router
from api.v1.endpoints.service import router as service_router
from api.v1.endpoints.analytics import router as analytics_router
...
api_router.include_router(busary_router)
